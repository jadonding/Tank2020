...
public class LRFireSrategy implements FireStrategy {
    ...
    public void fire(Player player) {
        ...
        TankFrame.INSTANCE.gm.getGameObjects().add(new Bullet(bX, bY, Dir.L, player.getGroup()));
        TankFrame.INSTANCE.gm.getGameObjects().add(new Bullet(bX, bY, Dir.R, player.getGroup()));
